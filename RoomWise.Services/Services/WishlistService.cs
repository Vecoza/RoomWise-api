...
public class WishlistService : IWishlistService
{
    ...
    public async Task<bool> AddAsync(Guid userId, int hotelId)
    {
    ...
    public async Task<bool> RemoveAsync(Guid userId, int hotelId)
    {
        var userIdStr = userId.ToString();
    ...
    public async Task<IReadOnlyList<HotelSearchItemResponse>> ListAsync(Guid userId)
    {
        var userIdStr = userId.ToString();
